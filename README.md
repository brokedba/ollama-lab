...
1. [OLLAMA](#ollama)
   ...
   - [Models](#models)
   - [Can My Machine Run LLM?](#can-my-machine-run-llm)
   - [Ollama Commands](#ollama-commands)
2. [Where are models stored?](#where-are-models-stored)
3. [VRAM Prerequisites](#vram-prereq)
4. [CPU Compatible Models](#cpu-compatible-models)
5. [Designing the Chatbot](#designing-the-chatbot)
6. [Test using Docker](#test-using-docker)
7. [Pull HuggingFace GGUF Models Manually using Ollama](#pull-huggingface-gguf-models-manually-using-ollama)
