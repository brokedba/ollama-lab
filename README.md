...
# Table of Contents
1. [OLLAMA](#ollama)
2. [Ollama Commands](#ollama-commands)
3. [HuggingFace and Ollama Comparison](#huggingface-and-vs-ollama)
4. [Where are models stored?](#where-are-models-stored)
5. [VRAM Prerequisites](#vram-prereq)
6. [CPU Compatible Models](#cpu-compatible-modells)
7. [Designing the Chatbot](#designing-the-chatbot)
8. [Test using Docker](#test-using-docker)
9. [Pull HuggingFace GGUF Models Manually using Ollama](#pull-hugginface-gguf-models-manually-using-ollama)
10. [Streamlit](#streamlit)
11. [OCI OKE Use Case](#oci-oke-use-case)
12. [Multimodal Vision Language Models](#multimodal-vision-language-models)
13. [Vision Models (GGUF)](#vision-models-gguf)
